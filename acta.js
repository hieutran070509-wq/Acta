(function(){
  ...
  var STRINGS = {
    en:{ tagline:"things done — not things planned", level:"LEVEL", ap:"AP", streak:"day streak",
      ...
      bootMsg:"Session started — Acta v5.0", philMsg:"Philosophy: things done, not things planned. No schedule, only recognition.",
    ...
    vi:{ tagline:"việc đã làm — không phải việc đã định", level:"CẤP", ap:"AP", streak:"ngày liên tiếp",
      ...
      bootMsg:"Phiên làm việc bắt đầu — Acta v5.0", philMsg:"Triết lý: việc đã làm, không phải việc đã định. Không lịch trình, chỉ ghi nhận.",
    ...
    es:{ tagline:"cosas hechas — no cosas planeadas", level:"NIVEL", ap:"PA", streak:"días seguidos",
      ...
      bootMsg:"Sesión iniciada — Acta v5.0", philMsg:"Filosofía: cosas hechas, no cosas planeadas. Sin horarios, solo reconocimiento.",
    ...
    fr:{ tagline:"des choses faites — pas des choses prévues", level:"NIVEAU", ap:"PA", streak:"jours de suite",
      ...
      bootMsg:"Session démarrée — Acta v5.0", philMsg:"Philosophie : des choses faites, pas des choses prévues. Pas d'horaire, juste de la reconnaissance.",
    ...
    de:{ tagline:"Erledigtes — kein Geplantes", level:"STUFE", ap:"AP", streak:"Tage in Folge",
      ...
      bootMsg:"Sitzung gestartet — Acta v5.0", philMsg:"Philosophie: Erledigtes zählt, nicht Geplantes. Kein Zeitplan, nur Anerkennung.",
    ...
    pt:{ tagline:"coisas feitas — não coisas planejadas", level:"NÍVEL", ap:"PA", streak:"dias seguidos",
      ...
      bootMsg:"Sessão iniciada — Acta v5.0", philMsg:"Filosofia: coisas feitas, não coisas planejadas. Sem agenda, só reconhecimento.",
    ...
    ja:{ tagline:"やったこと ― 予定ではなく", level:"レベル", ap:"AP", streak:"連続日数",
      ...
      bootMsg:"セッション開始 — Acta v5.0", philMsg:"理念：やったことがすべて、予定は関係ない。スケジュールではなく、認識を。",
    ...
    ko:{ tagline:"해낸 일 — 계획한 일이 아니라", level:"레벨", ap:"AP", streak:"일 연속",
      ...
      bootMsg:"세션 시작 — Acta v5.0", philMsg:"철학: 계획이 아니라 실행. 일정 대신 인정을.",
    ...
    zh:{ tagline:"已完成的事 — 而非计划中的事", level:"等级", ap:"AP", streak:"天连续",
      ...
      bootMsg:"会话已开始 — Acta v5.0", philMsg:"理念：重要的是已完成的事，而非计划的事。不需要日程，只需要认可。",
    ...
    ru:{ tagline:"сделанное — а не запланированное", level:"УРОВЕНЬ", ap:"AP", streak:"дней подряд",
      ...
      bootMsg:"Сессия начата — Acta v5.0", philMsg:"Философия: важно сделанное, а не запланированное. Никакого расписания — только признание.",
    ...
    hi:{ tagline:"जो किया — जो योजना बनाई वो नहीं", level:"स्तर", ap:"AP", streak:"दिन लगातार",
      ...
      bootMsg:"सत्र शुरू हुआ — Acta v5.0", philMsg:"दर्शन: जो किया वह मायने रखता है, जो योजना बनाई वह नहीं। कोई शेड्यूल नहीं, सिर्फ़ पहचान।",
    ...
    id:{ tagline:"hal yang dilakukan — bukan yang direncanakan", level:"LEVEL", ap:"AP", streak:"hari beruntun",
      ...
      bootMsg:"Sesi dimulai — Acta v5.0", philMsg:"Filosofi: yang dikerjakan, bukan yang direncanakan. Tanpa jadwal, hanya pengakuan.",
